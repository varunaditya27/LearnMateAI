      ...
      <div className="w-full max-w-[480px] px-4 z-10">
        ...
        >
          ...
          <div className="text-center mt-8 mb-8">
            ...
            <p className="text-[rgba(255,255,255,0.7)] text-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              ...
              <div className="absolute top-0 -left-full w-full h-full bg-gradient-to-r from-transparent via-[rgba(255,255,255,0.3)] to-transparent transition-[left] duration-500"></div>
            </motion.button>
          </form>
