      ...
      <Card className="w-full max-w-2xl bg-white border-[#e2e8f0] shadow-xl">
        <CardHeader className="text-center space-y-8 pb-12">
          ...
          <div className="space-y-6">
            <CardTitle className="text-4xl text-[#0f172a] font-bold">Create Your Account</CardTitle>
        ...
        <CardContent className="space-y-8">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-4">
              <label className="block text-[#4f46e5] text-xl font-semibold mb-3">Full Name</label>
              <input
                type="text"
            ...
            <div className="space-y-4">
              <label className="block text-[#4f46e5] text-xl font-semibold mb-3">Confirm Password</label>
              <input
                type="password"
        ...
        <CardFooter className="flex justify-center pt-12 pb-12">
          <p className="text-xl text-[#64748b]">
            ...
            <Link href="/login" className="text-[#4f46e5] font-bold hover:text-[#3730a3] hover:underline transition-colors text-xl">
              Sign in
            </Link>
          </p>
        </CardFooter>
